...
public class FavoriteMovieWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "com.william.cataloguemovieapplication.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.william.cataloguemovieapplication.EXTRA_ITEM";
